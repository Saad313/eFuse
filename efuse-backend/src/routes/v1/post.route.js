...
router.route('/:userId/posts').get(auth('getPosts'), validate(postValidation.getPosts), postController.getUsersPost);
 ...
 *   get:
 *     summary: Get a post
 *     description: Logged in posts can fetch only their own user information. Only admins can fetch other post.
 *     tags: [Posts]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in post can only update their own information. Only admins can update other users.
 *     tags: [Posts]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in content can delete only themselves. Only admins can delete other content.
 *     tags: [Posts]
 *     security:
 *       - bearerAuth: []
 *     parameters:
